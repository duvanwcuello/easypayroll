...
public class DatosDeUsoGeneral {
    ...
    private static final String ARCHIVO_NOVEDADES = "novedades_";
    ...
    public static String getArchivoNovedades() {

        asegurarArchivo(ARCHIVO_NOVEDADES);
        return ARCHIVO_NOVEDADES;
    }
